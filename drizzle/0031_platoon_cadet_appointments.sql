...
ALTER TABLE "cadet_appointments"
  ...
  FOREIGN KEY ("cadet_id") REFERENCES "oc_cadets"("id") ON DELETE restrict ON UPDATE no action;
--> statement-breakpoint
ALTER TABLE "cadet_appointments"
  ADD CONSTRAINT "cadet_appointments_platoon_id_platoons_id_fk"
  FOREIGN KEY ("platoon_id") REFERENCES "platoons"("id") ON DELETE restrict ON UPDATE no action;
--> statement-breakpoint
ALTER TABLE "cadet_appointments"
  ADD CONSTRAINT "cadet_appointments_appointed_by_users_id_fk"
  FOREIGN KEY ("appointed_by") REFERENCES "users"("id") ON DELETE set null ON UPDATE no action;
--> statement-breakpoint
ALTER TABLE "cadet_appointments"
