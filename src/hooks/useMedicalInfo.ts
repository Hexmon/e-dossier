            ...
            try {
                const response = await saveMedicalInfo(
                    ...
                    payload.map((r) => ({
                        ...
                        ...(typeof r.age === "number" && Number.isFinite(r.age) ? { age: r.age } : {}),
                        ...(typeof r.heightCm === "number" && Number.isFinite(r.heightCm) ? { heightCm: r.heightCm } : {}),
                        ...(typeof r.ibwKg === "number" && Number.isFinite(r.ibwKg) ? { ibwKg: r.ibwKg } : {}),
                        ...(typeof r.abwKg === "number" && Number.isFinite(r.abwKg) ? { abwKg: r.abwKg } : {}),
                        ...(typeof r.overwtPct === "number" && Number.isFinite(r.overwtPct) ? { overwtPct: r.overwtPct } : {}),
                        ...(typeof r.bmi === "number" && Number.isFinite(r.bmi) ? { bmi: r.bmi } : {}),
                        ...(typeof r.chestCm === "number" && Number.isFinite(r.chestCm) ? { chestCm: r.chestCm } : {}),
