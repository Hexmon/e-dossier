...
const MODULE_LABELS: Record<string, string> = {
  ...
  'interviews:initial:plcdr': 'Initial Interview / PL CDR Fields',
  'interviews:initial:dscoord': 'Initial Interview / DS Coord Fields',
  'interviews:initial:dycdr': 'Initial Interview / DY CDR Fields',
  'interviews:initial:cdr': 'Initial Interview / CDR Fields',
  'interviews:term:beginning:shared': 'Terms Interview / Beginning Shared Fields',
  'interviews:term:beginning:plcdr': 'Terms Interview / Beginning PL CDR Fields',
  'interviews:term:beginning:dscoord': 'Terms Interview / Beginning DS Coord Fields',
  'interviews:term:beginning:dycdr': 'Terms Interview / Beginning DY CDR Fields',
  'interviews:term:beginning:cdr': 'Terms Interview / Beginning CDR Fields',
  'interviews:term:postmid': 'Terms Interview / Post Mid Fields',
  'interviews:special': 'Special Interview Records',
  ...
  'site-settings:footer': 'Site Footer',
