...
async function POSTHandler(req: AuditNextRequest) {
  try {
    ...
    const objectKey = `site-settings/hero-bg/${randomUUID()}.${ext}`;
    ...
    await req.audit.log({
      ...
      target: { type: AuditResourceType.API, id: "admin:site-settings:hero-bg:presign" },
      metadata: {
        eventType: "SITE_SETTINGS_HERO_BG_PRESIGN_CREATED",
        description: "Generated hero background presigned upload URL.",
        objectKey,
        contentType,
        sizeBytes,
      },
