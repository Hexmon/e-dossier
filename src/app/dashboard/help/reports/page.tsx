...
export default async function ReportsGuidePage() {
  const markdown = await loadHelpMarkdown('reports.md');

  return (
    <DashboardLayout
      title="Reports"
      description="Report preview, download, version code, and verification guide"
    >
      <main className="p-6">
