...
import { OfficerCadetForm } from "@/types/dossierSnap";
...
export default function DossierSnapshot() {
  ...
  const { register, handleSubmit, reset, watch } = useForm<OfficerCadetForm>({
    defaultValues: {
      arrivalPhoto: null,departurePhoto: null,tesNo: "",name: "",course: "",pi: "",dtOfArr: "",relegated: "",withdrawnOn: "",dtOfPassingOut: "",icNo: "",orderOfMerit: "",regtArm: "",postedAtt: "",
    },
  });
