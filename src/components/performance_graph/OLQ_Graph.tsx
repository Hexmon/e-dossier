...
export default function OlqChart({ data: olqData }: { data: number[] }) {
  ...
  }, [olqData, averageData, themeVersion]);
    ...
    <div className="w-full max-w-4xl mx-auto p-6">
      <div className="bg-card rounded-2xl shadow-lg border border-border overflow-hidden">
        ...
        <div className="bg-primary px-6 py-6">
          <h2 className="text-2xl font-bold text-primary-foreground tracking-tight">🎯 OLQ</h2>
          <p className="text-primary-foreground/80 text-sm mt-1">Officer Like Qualities Performance Tracking</p>
        </div>
        ...
        <div className="grid grid-cols-3 gap-4 px-6 pb-6">
          <div className="bg-primary/10 rounded-lg p-4 border border-primary/20">
            ...
            <p className="text-2xl font-bold text-primary mt-1">{stats.highest}/300</p>
          ...
          <div className="bg-info/10 rounded-lg p-4 border border-info/20">
            ...
            <p className="text-2xl font-bold text-info mt-1">{stats.lowest}/300</p>
