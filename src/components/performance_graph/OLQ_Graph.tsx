...
export default function OlqGraph({ data: olqData }: { data: number[] }) {
    ...
    useEffect(() => {
        ...
        const firstValue = olqData[0];
        const lastValue = olqData[olqData.length - 1];
    ...
    }, [chartInstance, chartRef, olqData, labels, averageData]);
            ...
            <div className="bg-linear-to-br from-white to-slate-50 rounded-2xl shadow-lg border border-slate-100 overflow-hidden">
                ...
                <div className="bg-linear-to-r from-indigo-600 to-indigo-700 px-6 py-6">
                    ...
                    <p className="text-indigo-100 text-sm mt-1">
                        Officer Like Qualities Performance Tracking
                    </p>
                </div>
