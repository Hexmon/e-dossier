...
describe("dashboard appointments route", () => {
  ...
  it("returns platoon cadet appointments for dynamic platoon-cdr identities", async () => {
    vi.mocked(authz.requireAuth).mockResolvedValue({
      userId: "pl-cdr-1",
    ...
    vi.mocked(
      ...
      {
        appointmentId: "cadet-apt-2",
        positionName: "Cadet Adjutant",
        officerName: "OC-02 Cadet Two",
        ocNo: "OC-02",
        courseName: "TES 51",
  ...
  it("returns platoon cadet appointments for any platoon-scoped login", async () => {
    vi.mocked(authz.requireAuth).mockResolvedValue({
      userId: "scope-user-1",
      roles: ["some-other-role"],
      claims: {
        apt: {
          position: "some-other-role",
          scope: {
            type: "PLATOON",
            id: "platoon-1",
          },
    ...
    vi.mocked(
      ...
      {
        appointmentId: "cadet-apt-3",
        positionName: "Cadet QM",
        officerName: "OC-03 Cadet Three",
        ocNo: "OC-03",
        courseName: "TES 52",
